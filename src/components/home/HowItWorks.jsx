...
const HowItWorks = () => {
  ...
  return (
    <section className="mt-[60px] lg:mt-[120px]">
      <h1 className="font-black text-[28px] md:text-4xl leading-[42px] md:leading-[52px] text-center p-7 lg:p-0 md:px-20 lg:text-start lg:text-[52px] lg:leading-[80px] font-cw-primary">
      ...
      <p className="text-center leading-6 md:px-28 lg:text-start lg:px-0">
